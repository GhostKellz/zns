...
pub fn build(b: *std.Build) void {
    ...
    const zsync = b.lazyDependency("zsync", .{
        .target = target,
        .optimize = optimize,
    });
    ...
    if (zsync) |zsync_dep| {
        imports.append(.{ .name = "zsync", .module = zsync_dep.module("zsync") }) catch @panic("OOM");
    }
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "zns" is the name you will use in your source code to
                // import this module (e.g. `@import("zns")`). The name is
